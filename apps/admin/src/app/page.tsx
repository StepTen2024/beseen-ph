...
import { 
  Users, Store, FileText, TrendingUp, Eye, DollarSign,
  Sparkles, Clock, CheckCircle, AlertCircle, ChevronRight,
  BarChart2, Activity
} from 'lucide-react';
...
const RECENT_ACTIVITY = [
  ...
  { action: 'Subscription upgrade', subject: 'Mang Inasal → Malakas', time: '2 hours ago', icon: TrendingUp, color: 'text-amber-400' },
];
    ...
    <div className="min-h-screen bg-[#030712] text-white">
      <header className="sticky top-0 z-40 bg-[#030712]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 text-sm">Welcome back, Julie! 👋</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="px-3 py-1.5 rounded-lg bg-emerald-500/10 text-emerald-400 text-sm flex items-center gap-2">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Link
            href="/claims"
            className="p-6 rounded-2xl bg-gradient-to-r from-fuchsia-900/30 to-purple-900/30 border border-fuchsia-500/20 hover:border-fuchsia-500/40 transition-all"
          >
            <CheckCircle className="w-8 h-8 text-fuchsia-400 mb-3" />
          ...
          <Link
            href="/content"
            className="p-6 rounded-2xl bg-gradient-to-r from-cyan-900/30 to-blue-900/30 border border-cyan-500/20 hover:border-cyan-500/40 transition-all"
          >
          ...
          <Link
            href="/clients"
            className="p-6 rounded-2xl bg-gradient-to-r from-amber-900/30 to-orange-900/30 border border-amber-500/20 hover:border-amber-500/40 transition-all"
          >
